...
# Mail:         mm@mindcore.dk
# Twitter:      MMelkersen
# Function:     Sample script to upload Inplace upgrade logs to Azure Blob storage
# 
# Special Thanks: 
...
Start-Process -FilePath $Setupdiag -ArgumentList "/Output:C:\temp\logs\IPU\Results.log"
